export const xpRequirements = [
  100, 150, 250, 400, 550, 800, 1000, 1500, 2500, 4000, 6000, 12000, 3000, 10000
]
...
export const upgradesPool = [
  ...
  },
  {
    id: 2,
    name: 'Replentish I',
    description: 'Increases rate of energy return by 1',
    cost: 500,
    requiredLevel: 5,
  ...
  },
  {
    id: 3,
    name: 'Gardener I',
    description: 'Earn 2 extra herbs per gather.',
    cost: 750,
    requiredLevel: 7,
  ...
  },
  {
    id: 4,
    name: 'Garden Keep',
    description: 'Hire a Garden Keep to bring you herbs.',
    cost: 2000,
    requiredLevel: 9,
  ...
  },
  {
    id: 5,
    name: 'Coal Cart',
    description: 'Passively collect coal at a slow but useful rate.',
    cost: 2200,
    requiredLevel: 11,
  ...
  },
  {
    ...
    description: 'Increase water gather quantity by 4.',
    cost: 3250,
    requiredLevel: 12,
  ...
  },
  {
    id: 6,
    name: 'Max Energy I',
    description: 'Increase your maximum energy by 100.',
    cost: 4000,
    requiredLevel: 12,
  ...
  },
  {
    id: 7,
    name: 'Iron Well',
    description: 'Passively collect water at a fast inteval.',
    cost: 6500,
    requiredLevel: 13,
  ...
  },
  {
    ...
    description: 'Hire an apprentice who collects currency in unknown ways.',
    cost: 8000,
    requiredLevel: 14,
