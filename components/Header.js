...
export function Header () {
  ...
  return (
    <header
      className='w-full h-[100px] min-h-[100px] flex relative z-50'
      id='header'
    >
      <div className='flex items-center gap-8 pl-16' id='header-left'>
        <div>
          <Image
            src='/pink-iso-potion.gif'
            width={48}
            height={48}
            alt='Potion Icon'
          />
        ...
        <div className='font-mono relative'>
          ...
          {animationDivs.map(div => (
            <div
              key={div.id}
              className={`absolute inset-0 pointer-events-none text-sm flex items-center justify-center ${
                div.type === '+'
            ...
            >
              <span
                className={`flex items-center justify-center translate-y-[100%] ${
                  div.type === '+'
