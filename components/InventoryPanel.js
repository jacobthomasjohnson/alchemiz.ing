...
export function InventoryPanel () {
  ...
  const recentlyUpdatedInventoryItem = useGameStore(
    state => state.recentlyUpdatedInventoryItem
  )
  const clearRecentlyUpdatedInventoryItem = () =>
    useGameStore.setState({ recentlyUpdatedInventoryItem: null })
